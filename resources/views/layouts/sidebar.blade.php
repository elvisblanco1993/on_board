<div class="col-md-2">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a href="{{ url('users') }}" class="nav-link" style="color: {{ strpos(Route::current()->getName(), 'user') !== FALSE ? '#3273dc' : '#2a5164' }}">
                <i class="fas fa-user-friends mr-2" style="color: {{ strpos(Route::current()->getName(), 'user') !== FALSE ? '#3273dc' : '#c3cbd3' }}"></i>
                Users
            </a>
        </li>
        @endif
        ...
        <li class="nav-item">
            <a href="{{ url('documents') }}" class="nav-link" style="color: {{ strpos(Route::current()->getName(), 'document') !== FALSE ? '#3273dc' : '#2a5164' }}">
                <i class="fas fa-folder-open mr-2" style="color: {{ strpos(Route::current()->getName(), 'document') !== FALSE ? '#3273dc' : '#c3cbd3' }}"></i>
                Documents
            </a>
        </li>
